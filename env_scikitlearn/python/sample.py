...
logger.info(f'shape of data: {iris["data"].shape}')
...
X = np.array(dataset[['sepal_length', 'sepale_width', 'petal_length', 'petal_width']])

X_train, X_valid, Y_train, Y_valid = train_test_split(X, Y, test_siize=0.3, random_state=0)
